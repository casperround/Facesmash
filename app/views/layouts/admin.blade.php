        ...
        <div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
            <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="0" m-menu-dropdown-timeout="500"  >
                <ul class="m-menu__nav ">
                    ...
                    <li class="m-menu__item " aria-haspopup="true" >
                        <a href="{{ URL::route("admin.groups") }}" class="m-menu__link ">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item " aria-haspopup="true" >
                        <a href="{{ URL::route("admin.pages") }}" class="m-menu__link ">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item " aria-haspopup="true" >
                        <a href="{{ URL::route("admin.channels") }}" class="m-menu__link ">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item " aria-haspopup="true" >
                        <a href="{{ URL::route("admin.posts") }}" class="m-menu__link ">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item " aria-haspopup="true" >
                        <a href="{{ URL::route("admin.flags") }}" class="m-menu__link ">
                            <span class="m-menu__item-here"></span>
                    ...
                    <li class="m-menu__item " aria-haspopup="true" >
                        <a href="{{ URL::route("admin.contact") }}" class="m-menu__link ">
                            <span class="m-menu__item-here"></span>
                            <i class="m-menu__link-icon fas fa-pencil-alt"></i>
                            <span class="m-menu__link-text">
                                Contact Messages

            ...
            <div class="col-md" style="overflow-y:scroll;margin-top:10px;padding:10px;background:#efefef;height:100vh;">
                ...
                <div class="info">
                    <div class="buttons">
                        ...
                        @if ($errors->has('unique_groupname'))
                            @foreach ($errors->get('unique_groupname') as $error)
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><span style="color: black">New Group</span></h5>
                            ...
                            <div class="modal-body" style="color: black">
                                <form action="{{ URL::route("groups.userGroupsNewPage") }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="unique_pagename">Group Name</label>
                                        <input type="text" id="unique_groupname" name="unique_groupname" class="form-control" required>
                                    </div>
                ...
                <div class="card-columns">
                    <div class="col-md">
                        @foreach(Groups::where("owner_id", "=", Auth::user()->id)->get() as $groups)
                            <a href="{{ URL::route("groupsview", $groups->unique_groupname) }}"><div class="card">

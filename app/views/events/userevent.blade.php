            ...
            <div class="col-md" style="overflow-y:scroll;margin-top:10px;padding:10px;background:#efefef;height:100vh;">
                ...
                <div class="info">
                    <div class="buttons">
                        ...
                        @if ($errors->has('unique_eventname'))
                            @foreach ($errors->get('unique_eventname') as $error)
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><span style="color: black">New Event</span></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body" style="color: black">
                                <form action="{{ URL::route("events.userEventsNewPage") }}" method="POST">

                                    <div class="form-group">
                                        <label for="unique_pagename">Event Name</label>
                                        <input type="text" id="unique_eventname" name="unique_eventname" class="form-control" required>
                                    </div>
